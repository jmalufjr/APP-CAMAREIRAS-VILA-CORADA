...
// horário estava faltando. Componente de servidor: sem `timeZone`
// explícito, usava o fuso do processo que renderiza (UTC na Vercel), não
// o horário oficial de Brasília — o admin via a hora 3h adiantada.
